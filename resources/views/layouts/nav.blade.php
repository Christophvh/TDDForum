            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="{{ action('ThreadsController@index',null) }}">
                                All Threads
                            </a>
                        </li>
                        @if(auth()->check())
                            <li>
                                <a href="{{ action('ThreadsController@index', ['channel' => null, 'by' => auth()->user()->name]) }}">
                                    My Threads
                                </a>
                            </li>
                        @endif
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @foreach($channels as $channel)
                            <li>
                                <a href="{{ action('ThreadsController@index', $channel) }}">
                                    {{ $channel->name }}
                                </a>
                            </li>
                        @endforeach
                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <a href="{{ action('ProfilesController@show', auth()->user()) }}">
                                    My Profile
                                </a>
                            </li>
                            <li>
